...
//   * rom_wit_wtgps_300/WitGpsStatus -> fix type, DOP and satellites in view
//
...
#include "rom_wit_wtgps_300/msg/satellite_info.hpp"
#include "rom_wit_wtgps_300/msg/wit_gps_status.hpp"
...
public:
  ...
  : rclcpp::Node("wit_gps_300_ttl")
  {
    ...
    status_pub_ =
      create_publisher<rom_wit_wtgps_300::msg::WitGpsStatus>(status_topic_, 10);
...
private:
  ...
  void handleGsa(const std::string & sentence)
  {
    ...
    rom_wit_wtgps_300::msg::WitGpsStatus status;
  ...
  void handleGsv(const std::string & sentence)
  {
    ...
    for (const auto & s : f.sats) {
      if (s.nr != 0) {
        rom_wit_wtgps_300::msg::SatelliteInfo info;
        info.prn = s.nr;
  ...
  std::vector<rom_wit_wtgps_300::msg::SatelliteInfo> sat_accum_;
  std::vector<rom_wit_wtgps_300::msg::SatelliteInfo> sat_list_;

  // --- ROS interfaces ---
  rclcpp::Publisher<sensor_msgs::msg::NavSatFix>::SharedPtr fix_pub_;
  rclcpp::Publisher<geometry_msgs::msg::TwistStamped>::SharedPtr vel_pub_;
  rclcpp::Publisher<sensor_msgs::msg::TimeReference>::SharedPtr time_pub_;
  rclcpp::Publisher<rom_wit_wtgps_300::msg::WitGpsStatus>::SharedPtr status_pub_;
