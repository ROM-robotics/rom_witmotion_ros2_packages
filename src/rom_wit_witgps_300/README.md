...
| `gps/status` | `rom_wit_witgps_300/WitGpsStatus` | fix type + PDOP/HDOP/VDOP + satellites |
...
# normal build
colcon build --packages-select rom_wit_witgps_300

# debug build — ရလာတဲ့ NMEA field အကုန်ကို RCLCPP_INFO ထုတ်မယ် (#ifdef ROM_DEBUG)
colcon build --packages-select rom_wit_witgps_300 --cmake-args -DROM_DEBUG=ON

source install/setup.bash
ros2 launch rom_wit_witgps_300 witgps.launch.py
